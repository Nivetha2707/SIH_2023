...
def generate_decreased_flowrate_data():
...
# Uncomment the line below to start generating realistic flow rate data with a slightly decreased flow rate
generate_decreased_flowrate_data()
