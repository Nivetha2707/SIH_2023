...
twilio_account_sid = "ACe6823381435fdf2968d86871237"
twilio_auth_token = "a85bc36af54b7bda7664f6f41e3"
twilio_phone_number = "+12055286264"
recipient_phone_number = "+99344465"
    ...
    if db_connection:
        try:
            ...
            while continue_monitoring:
                ...
                print(
                    f"Timestamp: {timestamp}, Flow Rate (Leak): {flow_rate_lps_leak:.4f} L/s, Amount Passed (Leak): {amount_passed_liter_leak:.4f} liters, Total Water Passed (Leak): {total_water_passed_leak:.4f} liters, Velocity (Leak): {velocity_leak:.4f} m/s, Acceleration (Leak): {acceleration_leak:.4f} m/s^2"
                )
                ...
                print(
                    f"Timestamp: {timestamp}, Flow Rate (No Leak): {flow_rate_lps_no_leak:.4f} L/s,  Amount Passed (No Leak): {amount_passed_liter_no_leak:.4f} liters, Total Water Passed (No Leak): {total_water_passed_no_leak:.4f} liters, Velocity (No Leak): {velocity_no_leak:.4f} m/s, Acceleration (No Leak): {acceleration_no_leak:.4f} m/s^2"
                )
                ...
                print(
                    f"Timestamp: {timestamp}, Flow Rate (Sensor): {flow_rate_lps_no_leak:.4f} L/s,  Amount Passed (Sensor): {amount_passed_liter_no_leak:.4f} liters, Total Water Passed (Sensor): {total_water_passed_no_leak +2:.4f} liters, Velocity (Sensor): {velocity_no_leak:.4f} m/s, Acceleration (Sensor): {acceleration_no_leak:.4f} m/s^2"
                )
